...
export default function AboutUs() {
  ...
  const stats = [
    { value: 250, label: "🏆 250+ Happy Clients " },
    { value: 50, label: "👥 50+ Team Members" },
    { value: 510, label: "📈 510+ Projects Completed " },
    { value: 12, label: "🎖 12+ Awards Won" },
  ];
      ...
      <div className="overflow-hidden">
        ...
        >
          ...
          <div className="text-center md:text-left max-w-lg">
            ...
            <h4>Welcome to CobazTech – Where Innovation Meets Excellence!</h4>
            <br />
        ...
        <div className="relative w-full py-20 flex justify-center items-center overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600">
          ...
          <div className="relative flex flex-col md:flex-row gap-8 text-white p-4 max-w-6xl">
            ...
            >
              ...
              <p className="text-lg">
                📌 To be the leading provider of digital solutions, empowering
        ...
        <section className="py-20 px-6 bg-gradient-to-br from-yellow-50 to-white">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12 text-center max-w-3xl mx-auto">
              💡 We provide insights-based solutions to help businesses grow
...
behind our success
        ...
        <div className="flex flex-col items-center justify-center py-20 px-8 bg-gradient-to-b from-white to-gray-100">
          ...
          >
            🎯 We follow a systematic approach to ensure the success of your digital initiatives, maximizing
