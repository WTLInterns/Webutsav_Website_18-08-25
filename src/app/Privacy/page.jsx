    ...
    <div className="pt-20 pb-10 bg-black">
      <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg text-black">
        ...
        <section className="mt-6 border-b pb-4">
          ...
          <h3 className="font-semibold mt-2 text-gray-700">B. Non-Personal Information:</h3>
          <ul className="list-disc pl-5 text-gray-600">
          ...
          <h3 className="font-semibold mt-2 text-gray-700">C. Information from Third Parties:</h3>
        ...
        <section className="mt-6 border-b pb-4">
          <h2 className="text-2xl font-semibold text-gray-800">4. How We Protect Your Data</h2>
          <p className="text-gray-600">
