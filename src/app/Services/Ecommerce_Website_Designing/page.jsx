  ...
  return (
    ...
    <section className="w-full py-10 bg-gradient-to-br from-blue-900 to-indigo-900 text-white">
      <div className="container px-4 mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-6">Ecommerce Website Designing Services in Pune, Mumbai & Across India</h2>
    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <FadeInSection>
          <h3 className="text-2xl font-semibold mb-12 text-center">Our Expertise in Ecommerce Development</h3>
        </FadeInSection>
