...
const faqs = [
  ...
  {
    question:
      "05. How long does it take to see results from social media marketing?",
    answer:
        ...
        <div className="flex flex-wrap p-6 bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="w-full md:w-3/5 max-w-8xl mx-auto py-12 px-6">
            ...
            >
              ...
              Google AdWords services. We design and implement custom
              advertising campaigns tailored to your unique business needs,
              seamlessly integrating with your overall digital marketing
              strategy for increased visibility, traffic, and conversions.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              for your products or services. Our team excels in crafting
              campaigns that maximize visibility and return on investment (ROI).
            </motion.p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap p-6 bg-gradient-to-b from-white to-yellow-50">
          ...
          <div className="w-full md:w-3/5 max-w-8xl mx-auto py-1 pl-8 h-auto">
            ...
            <motion.p
              ...
              className="text-gray-600 text-lg md:text-xl"
            >
              Whether you're a local startup or a global enterprise, our
              expertise ensures that your Google Ads campaigns generate the best
              results. We stay updated with the latest AdWords innovations and
              best practices to keep your brand ahead of the competition. With
              our commitment to excellence, we help your business grow, scale,
              and succeed in the competitive digital marketplace. Let us take
              your Google AdWords campaigns to the next level, delivering
              measurable results and driving success for your brand.
            </motion.p>
          </div>
        </div>
